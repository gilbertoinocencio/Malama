...
export const FoodService = {
    ...
    async seedInitialFoods() {
        ...
        const initialFoods: FoodItem[] = [
            ...
            { name: 'Fígado bovino',        category: 'protein', tier: 'budget',   calories: 135, macros: { p: 20, c: 4,  f: 4  }, quality_score: 4, image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Pig%27s_liver_with_sauteed_onion.jpg/330px-Pig%27s_liver_with_sauteed_onion.jpg' },
            { name: 'Atum em lata',         category: 'protein', tier: 'budget',   calories: 116, macros: { p: 26, c: 0,  f: 1  }, quality_score: 3, image_url: 'https://d8j0ntlcm91z4.cloudfront.net/user_3DJ7gA43yLLLhgCCX7cXcIAl932/hf_20260623_194404_64d42186-f67a-4107-93f6-5db40d309385.jpeg' },
            ...
            { name: 'Feijão carioca',      category: 'protein', tier: 'budget',   calories: 76,  macros: { p: 5,  c: 14, f: 0  }, quality_score: 3, image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Pinto_Beans_Seeds.jpg/330px-Pinto_Beans_Seeds.jpg' },
            ...
            { name: 'Tilápia',             category: 'protein', tier: 'balanced', calories: 128, macros: { p: 26, c: 0,  f: 3  }, quality_score: 3, image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Oreochromis-niloticus-Nairobi.JPG/330px-Oreochromis-niloticus-Nairobi.JPG' },
            ...
            { name: 'Músculo bovino',       category: 'protein', tier: 'balanced', calories: 155, macros: { p: 25, c: 0,  f: 5  }, quality_score: 3, image_url: 'https://upload.wikimedia.org/wikipedia/commons/e/e1/Ossobuco.jpg' },
            { name: 'Queijo cottage',       category: 'protein', tier: 'balanced', calories: 98,  macros: { p: 11, c: 3,  f: 5  }, quality_score: 3, image_url: 'https://d8j0ntlcm91z4.cloudfront.net/user_3DJ7gA43yLLLhgCCX7cXcIAl932/hf_20260623_194401_b9ab6f46-945c-4aec-b873-45aafc395ad0.jpeg' },
            { name: 'Atum em água',         category: 'protein', tier: 'balanced', calories: 110, macros: { p: 25, c: 0,  f: 1  }, quality_score: 3, image_url: 'https://d8j0ntlcm91z4.cloudfront.net/user_3DJ7gA43yLLLhgCCX7cXcIAl932/hf_20260623_194404_64d42186-f67a-4107-93f6-5db40d309385.jpeg' },
            ...
            { name: 'Feijão preto',        category: 'carbs',   tier: 'budget',   calories: 132, macros: { p: 9,  c: 24, f: 0  }, quality_score: 3, image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b4/Black_Beans_2.JPG/330px-Black_Beans_2.JPG' },
            { name: 'Tapioca',             category: 'carbs',   tier: 'budget',   calories: 98,  macros: { p: 0,  c: 24, f: 0  }, quality_score: 2, image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Tepung_casava.jpg/330px-Tepung_casava.jpg' },
            { name: 'Cuscuz de milho',     category: 'carbs',   tier: 'budget',   calories: 112, macros: { p: 2,  c: 24, f: 1  }, quality_score: 2, image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/Moroccan_cuscus%2C_from_Casablanca%2C_September_2018.jpg/330px-Moroccan_cuscus%2C_from_Casablanca%2C_September_2018.jpg' },

            // CARBOIDRATOS — Balanced
            { name: 'Batata doce',         category: 'carbs',   tier: 'balanced', calories: 86,  macros: { p: 2,  c: 20, f: 0  }, quality_score: 3, image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/Ipomoea_batatas_006.JPG/330px-Ipomoea_batatas_006.JPG' },
            ...
            { name: 'Mandioca',            category: 'carbs',   tier: 'balanced', calories: 160, macros: { p: 1,  c: 38, f: 0  }, quality_score: 2, image_url: 'https://upload.wikimedia.org/wikipedia/commons/b/b1/Cassava_roots_for_peeling.jpg' },
            { name: 'Inhame',              category: 'carbs',   tier: 'balanced', calories: 118, macros: { p: 2,  c: 28, f: 0  }, quality_score: 3, image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/72/Yam_at_monday_market_kaduna_state_01.jpg/330px-Yam_at_monday_market_kaduna_state_01.jpg' },
            ...
            { name: 'Quinoa',              category: 'carbs',   tier: 'premium',  calories: 120, macros: { p: 4,  c: 21, f: 2  }, quality_score: 4, image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Quinoa.jpg/330px-Quinoa.jpg' },
            ...
            { name: 'Granola natural',     category: 'carbs',   tier: 'premium',  calories: 471, macros: { p: 10, c: 63, f: 21 }, quality_score: 3, image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/Granola%2C_yogurt%2C_fruit._%2816696981528%29.jpg/330px-Granola%2C_yogurt%2C_fruit._%2816696981528%29.jpg' },
            { name: 'Batata yacon',        category: 'carbs',   tier: 'premium',  calories: 54,  macros: { p: 1,  c: 13, f: 0  }, quality_score: 4, image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Yacon.jpg/330px-Yacon.jpg' },
            { name: 'Macarrão de arroz',   category: 'carbs',   tier: 'premium',  calories: 109, macros: { p: 2,  c: 25, f: 0  }, quality_score: 3, image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Rice_vermicelli.jpg/330px-Rice_vermicelli.jpg' },
            ...
            { name: 'Linhaça',             category: 'fats',    tier: 'budget',   calories: 534, macros: { p: 18, c: 29, f: 42 }, quality_score: 4, image_url: 'https://upload.wikimedia.org/wikipedia/commons/f/f5/Flaxseed.jpg' },
            { name: 'Gergelim',            category: 'fats',    tier: 'budget',   calories: 573, macros: { p: 17, c: 23, f: 50 }, quality_score: 3, image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/Sesame_seeds_closeup.jpg/330px-Sesame_seeds_closeup.jpg' },
            { name: 'Creme de leite',      category: 'fats',    tier: 'budget',   calories: 337, macros: { p: 2,  c: 3,  f: 35 }, quality_score: 2, image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/Milk_heavy_cream.jpg/330px-Milk_heavy_cream.jpg' },
            ...
            { name: 'Chia',                category: 'fats',    tier: 'balanced', calories: 486, macros: { p: 17, c: 42, f: 31 }, quality_score: 4, image_url: 'https://upload.wikimedia.org/wikipedia/commons/5/5b/Mexican_chia_seeds_%281%29.jpg' },
            ...
            // GORDURAS — Premium
            { name: 'Nozes',               category: 'fats',    tier: 'premium',  calories: 654, macros: { p: 15, c: 14, f: 65 }, quality_score: 4, image_url: 'https://upload.wikimedia.org/wikipedia/commons/b/b2/Walnuts_-_whole_and_open_with_halved_kernel.jpg' },
            ...
            { name: 'Macadâmia',           category: 'fats',    tier: 'premium',  calories: 718, macros: { p: 8,  c: 14, f: 76 }, quality_score: 4, image_url: 'https://upload.wikimedia.org/wikipedia/commons/9/96/Macadamia_nuts_on_tree.JPG' },
            { name: 'Pistache',            category: 'fats',    tier: 'premium',  calories: 562, macros: { p: 20, c: 28, f: 45 }, quality_score: 4, image_url: 'https://upload.wikimedia.org/wikipedia/commons/e/e8/Pistachio_Nuts_%28Unsplash%29.jpg' },
            { name: 'Tahine',              category: 'fats',    tier: 'premium',  calories: 595, macros: { p: 17, c: 21, f: 54 }, quality_score: 4, image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/Tahina.JPG/330px-Tahina.JPG' },
