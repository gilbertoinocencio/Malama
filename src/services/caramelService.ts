...
import { CaramelAI, CARAMEL_AUTO_MODEL, CARAMEL_DEEP_MODEL, CARAMEL_FAST_MODEL } from '../lib/caramelAI';
...
const DEEP_MODEL_NAME = CARAMEL_DEEP_MODEL;
...
export const lookupSingleItem = async (
  ...
  // Primary source: OpenFoodFacts. Falls back to TACO/USDA via Caramel.
...
export const generateDoctorBriefing = async (patient: any): Promise<string> => {
  ...
  try {
    ...
    console.error("Caramel Doctor Briefing Error:", error);
