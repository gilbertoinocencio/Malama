...
// Capítulos do CID-10 relevantes para saúde ocupacional. A letra é tudo
// que se guarda — nunca o código de quatro dígitos.
const CID_GRUPOS: { letra: string; label: string }[] = [
...
const CID_LABEL: Record<string, string> = Object.fromEntries(
