    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          <motion.div
            className="absolute bottom-10 left-0 z-50 flex items-center gap-1 bg-white dark:bg-Malama-dark
              rounded-full shadow-xl border border-gray-200 dark:border-white/10 px-2 py-1.5"
          ...
          >
            {REACTIONS.map((r, i) => (
              <motion.button
                ...
                className="flex flex-col items-center p-1 rounded-full hover:bg-gray-100 dark:hover:bg-[#403d3a] transition-colors"
