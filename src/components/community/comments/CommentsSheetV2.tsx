    ...
    <AnimatePresence>
      ...
      >
        ...
        >
              ...
              <div className="space-y-3">
                {[1, 2, 3].map(i => (
                  <div key={i} className="flex gap-2.5">
                    ...
                    <div className="flex-1 h-14 bg-gray-100 dark:bg-gray-800 rounded-xl animate-pulse" />
                  </div>
                ))}
              </div>
            ) : comments.length === 0 ? (
          ...
          {/* Input */}
          <div className="px-4 py-3 border-t border-gray-100 dark:border-gray-800 shrink-0 pb-safe">
            {replyingTo && (
              <div className="flex items-center justify-between mb-1.5 px-1">
                <span className="text-xs text-gray-400">
                  Respondendo a <span className="font-semibold text-gray-600 dark:text-gray-300">@{replyingTo.author.display_name}</span>
                </span>
            ...
            <div className="flex gap-2 items-end">
              ...
              <button
                ...
                className="w-10 h-10 bg-[#2ECC71] disabled:bg-gray-200 dark:disabled:bg-gray-700 rounded-full
