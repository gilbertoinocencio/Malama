...
export const PostCardSkeleton: React.FC = () => (
  ...
  >
    ...
    <div className="h-40 w-full bg-gray-100 dark:bg-gray-800 rounded-xl animate-pulse mb-3" />
    <div className="flex gap-4">
      <div className="h-7 w-14 bg-gray-100 dark:bg-gray-800 rounded-full animate-pulse" />
      <div className="h-7 w-14 bg-gray-100 dark:bg-gray-800 rounded-full animate-pulse" />
    </div>
  </motion.div>
);
