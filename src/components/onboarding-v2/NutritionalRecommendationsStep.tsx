...
interface NutritionalRecommendationsStepProps extends Omit<StepProps, 'data' | 'updateData'> {
  data?: any;
  updateData?: any;
  onComplete?: () => void;
}

const NutritionalRecommendationsStep: React.FC<NutritionalRecommendationsStepProps> = ({
  onNext,
  onBack,
  currentStep,
  totalSteps,
