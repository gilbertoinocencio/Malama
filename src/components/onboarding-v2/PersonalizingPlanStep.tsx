    ...
    <StepContainer currentStep={currentStep} totalSteps={totalSteps} onBack={onBack} showBack={true}>
      <div className="flex flex-col h-full justify-center items-center">
        <div className="text-center max-w-2xl">
          <div className="text-6xl mb-8">⚙️</div><h1 className="text-3xl font-bold mb-4">A personalizar plano</h1><p className="text-gray-600 dark:text-gray-400">Aguarde um momento...</p>
