  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4 w-full mb-8">
        ...
        {/* Fat — full width */}
        <div className="col-span-2 bg-surface-container-low rounded-lg p-6 hover:bg-tertiary-fixed transition-colors duration-500 group flex items-center justify-between">
          <div>
            ...
            <h4 className="font-headline font-bold text-xl text-tertiary mb-1">Gordura</h4>
            <p className="text-on-surface-variant text-sm">Suporte hormonal e vitaminas lipossolúveis.</p>
          </div>
          <div className="text-right">
            <p className="font-headline font-black text-5xl text-tertiary">
              {fat}<span className="text-xl font-medium opacity-60">g</span>
            </p>
            <p className="text-tertiary/60 font-headline font-bold uppercase tracking-tighter mt-1 text-xs">30% do Plano</p>
          </div>
        </div>
      </div>
