          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
            <div className="w-48 h-48 md:w-56 md:h-56 relative flex items-center justify-center">
              ...
              <div className="w-full h-full rounded-full border-[10px] border-surface-container-highest flex items-center justify-center overflow-hidden">
                <div className="w-full h-1/2 bg-primary-fixed absolute top-0 flex items-center justify-center">
                  <span className="material-symbols-outlined text-primary text-4xl">light_mode</span>
                </div>
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-2">
                ...
                <span className="px-3 py-1 bg-primary-fixed/30 text-primary text-xs font-semibold rounded-full">Equilíbrio</span>
              </div>
            </div>
          </div>
        </div>
