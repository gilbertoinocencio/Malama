  ...
  return (
    ...
    >
      <section className="mb-12 space-y-4">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-tertiary leading-tight tracking-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
        ...
        <div className="md:col-span-8 bg-surface-container-lowest rounded-xl p-8 shadow-sm relative overflow-hidden group">
          <div className="flex justify-between items-end mb-8">
            <div>
              <h3 className="text-tertiary font-headline font-bold text-xl">Eficiência Metabólica</h3>
          ...
          <div className="relative h-48 w-full flex items-end gap-2 px-2">
            <div className="absolute inset-0 flex flex-col justify-between py-1 opacity-10 pointer-events-none border-y border-tertiary/20">
            ...
            {[30, 42, 55, 72, 95].map((height, i) => (
              <motion.div 
                ...
                className={`flex-1 rounded-t-lg transition-all duration-500 ${
                  i === 4 ? 'bg-tertiary relative' : 'bg-surface-container-high hover:bg-tertiary-fixed-dim'
                }`}
              >
                {i === 4 && (
        ...
        <div className="md:col-span-4 bg-surface-container-low rounded-xl p-6 flex flex-col justify-between aspect-square group transition-all duration-300 hover:bg-white hover:shadow-xl">
          ...
          <div>
            ...
            <h4 className="text-2xl font-bold text-tertiary font-headline">500ml</h4>
            <p className="text-xs text-on-surface-variant mt-2">Ingestão matinal aumenta o metabolismo em 30% nos primeiros 60 min.</p>
          </div>
        </div>

        {/* Wide Insight Card */}
        <div className="md:col-span-12 flex flex-col md:flex-row gap-8 items-center bg-tertiary text-on-tertiary p-8 rounded-xl shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 right-0 opacity-10 translate-x-1/4 -translate-y-1/4">
            <span className="material-symbols-outlined text-[20rem]" style={{ fontVariationSettings: "'wght' 100" }}>waves</span>
          </div>
          <div className="flex-shrink-0 w-24 h-24 rounded-full border-2 border-tertiary-fixed-dim/30 flex items-center justify-center p-2">
          ...
          <div className="relative z-10">
            ...
            <p className="text-on-tertiary-container text-opacity-90 max-w-xl leading-relaxed">
