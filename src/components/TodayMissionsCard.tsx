...
export const TodayMissionsCard: React.FC<TodayMissionsCardProps> = ({ onNavClick, onFabClick }) => {
    ...
    return (
      <div className="bg-white dark:bg-surface-dark rounded-3xl p-6 shadow-md animate-pulse">
        ...
        <div className="space-y-3">
          <div className="h-16 bg-gray-200 dark:bg-[#363330] rounded-2xl"></div>
          <div className="h-16 bg-gray-200 dark:bg-[#363330] rounded-2xl"></div>
        </div>
      </div>
    );
  ...
  return (
    <div className="bg-gradient-to-br from-Malama-petrol/5 to-Malama-pastel-orange/10 dark:from-primary/5 dark:to-primary/10 rounded-3xl p-6 border border-Malama-petrol/20 dark:border-primary/20">
      ...
      {/* Progress Bar */}
      <div className="mb-5">
        <div className="h-2 bg-gray-200 dark:bg-[#363330] rounded-full overflow-hidden">
          <div
      ...
      className={`
        ...
        ${
          mission.completed
            ...
            : 'bg-white dark:bg-surface-dark border-2 border-Malama-border dark:border-white/10 hover:border-Malama-petrol/50 dark:hover:border-primary/50 active:scale-[0.98]'
        }
      `}
    >
      {/* Icon */}
      ...
      <div className="flex-1 text-left">
        ...
        {mission.target_value && (
          <div className="flex items-center gap-2">
            <div className="flex-1 h-1.5 bg-gray-200 dark:bg-[#363330] rounded-full overflow-hidden">
              <div
                className={`
