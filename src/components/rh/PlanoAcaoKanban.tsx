...
// Campo vazio com "um ponto por linha" parece que a leitura falhou. Quando
// os relatórios não acharam nada favorável, o placeholder diz isso e manda
// a conversa buscar — é dado que só o gestor tem.
const placeholderFortes = (d: Diagnostico | null) =>
  d && d.fortes.length === 0 && d.atencao.length > 0
    ? 'Os relatórios não apontaram nada favorável neste setor. Anote o que a liderança trouxer na conversa.'
    : 'Um ponto por linha';
