    ...
    <div className="relative flex h-auto min-h-screen w-full flex-col mx-auto max-w-md bg-Malama-bg dark:bg-background-dark shadow-xl text-Malama-main dark:text-white font-display animate-fade-in">
      ...
      <main className="flex-1 flex flex-col gap-6 p-4">
          ...
          <div className="group flex flex-col items-stretch justify-start rounded-2xl shadow-sm border border-Malama-border dark:border-gray-800 bg-white dark:bg-[#1a2630] overflow-hidden transition-transform hover:scale-[1.01] duration-300">
            ...
            <div className="flex w-full flex-col gap-4 p-5">
              ...
              <div className="flex items-center justify-between">
                ...
                <button className="flex items-center gap-1 text-Malama-petrol dark:text-primary text-sm font-bold hover:opacity-80 transition-colors">
        ...
        <section className="flex flex-col items-center justify-center py-6 relative animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-Malama-petrol/10 dark:bg-primary/5 rounded-full blur-3xl pointer-events-none"></div>
          <div className="relative w-64 h-64 flex items-center justify-center">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-2">
              <div className="w-4 h-4 bg-Malama-petrol dark:bg-primary rounded-full shadow-[0_0_12px_rgba(17,164,212,0.8)] border-2 border-white dark:border-background-dark"></div>
            </div>
          </div>
          ...
          <div className="mt-8 text-center px-4 max-w-xs">
            <p className="text-Malama-main/80 dark:text-gray-300 text-lg leading-relaxed">
              {fa.addedMessage.split(/<bold>(.*?)<\/bold>/).map((part, i) =>
                i % 2 === 1
                  ? <span key={i} className="font-bold text-Malama-petrol dark:text-primary">{part.replace('{kcal}', '400')}</span>
